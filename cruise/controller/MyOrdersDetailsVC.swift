...
//  cruise
//
//  Created by ahmed abdelhameed on 1/10/19.
//  Copyright © 2019 ahmed abdelhameed. All rights reserved.
//

import UIKit

class MyOrdersDetailsVC: UIViewController , UITableViewDelegate , UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        print("$$$$$  \(clientname)  \(clientaddress) \(orderdate) \(totalprice)")
